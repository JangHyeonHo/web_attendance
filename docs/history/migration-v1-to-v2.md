...
- 프론트엔드 점검 보고서: [frontend-review.md](./frontend-review.md) — **이력 문서**.
  당시의 URL 라우팅 권장안은 서버 주도 화면전환(navigation) 복원 결정(patch-notes D7)으로 미채택,
  현행 프론트 문서는 `frontend/README.md`
