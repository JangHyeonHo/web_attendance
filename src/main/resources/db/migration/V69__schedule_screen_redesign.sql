...
('W009','APPLY_TITLE','KOR','이 스케줄을 다른 멤버에게도 적용'),
('W009','APPLY_TITLE','ENG','Apply this schedule to other members'),
('W009','APPLY_TITLE','JPN','このスケジュールを他のメンバーにも適用'),
('W009','APPLY_HINT','KOR','정기 스케줄과 이 달 상세(예외)를 선택한 멤버에게 그대로 지정합니다.'),
('W009','APPLY_HINT','ENG','Assign the regular schedule and this month''s detail to the selected members.'),
('W009','APPLY_HINT','JPN','定期スケジュールと当月の詳細を選択したメンバーにそのまま設定します。'),
