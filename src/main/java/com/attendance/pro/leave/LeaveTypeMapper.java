...
public interface LeaveTypeMapper {
    ...
    String COLS = "leave_type_id, tenant_id, code, name, paid, unit, hourly_enabled, requires_approval, "
    ...
    @Insert("""
            INSERT INTO leave_type (tenant_id, code, name, paid, unit, hourly_enabled, requires_approval,
                                    is_annual, active, sort_order)
            VALUES (#{tenantId}, #{code}, #{name}, #{paid}, #{unit}, #{hourlyEnabled}, #{requiresApproval},
    ...
    int update(@Param("tenantId") long tenantId, @Param("leaveTypeId") long leaveTypeId,
            @Param("name") String name, @Param("paid") boolean paid,
            @Param("unit") LeaveUnit unit, @Param("hourlyEnabled") boolean hourlyEnabled,
            @Param("requiresApproval") boolean requiresApproval,
    ...
    class LeaveTypeCreate {
        ...
        public LeaveTypeCreate(long tenantId, String code, String name, boolean paid,
                LeaveUnit unit, boolean hourlyEnabled, boolean requiresApproval, int sortOrder) {
